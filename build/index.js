...
var React__default = /*#__PURE__*/_interopDefaultLegacy(React$6);
...
function useBootstrapPrefix(prefix, defaultPrefix) {
  const {
    prefixes
  } = React$6.useContext(ThemeContext);
...
var Brodcast = function (_a) {
    ...
    return (React__namespace.createElement("section", { className: "brodcast-functions" },
        React__namespace.createElement(Container$1, { className: "functions" },
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement("div", { className: "function-parent" }, page3.func_img.map(function (value, index) {
                    return React__namespace.createElement(React__namespace.Fragment, { key: index },
                        React__namespace.createElement(Col$1, { md: 3, lg: 3, className: "function-col" },
                            React__namespace.createElement("div", { className: "function-image" },
                                React__namespace.createElement("img", { src: value.image, alt: "Image not found" })),
                            React__namespace.createElement("h6", { className: "mt-3" }, value.title)),
                        React__namespace.createElement("div", { className: "border-lines" },
                            React__namespace.createElement("span", { className: "line" }),
                            React__namespace.createElement("span", { className: "line" }),
                            React__namespace.createElement("span", { className: "line" })));
                })))),
        React__namespace.createElement(Container$1, { fluid: true },
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, { lg: 6, className: "broadcast_left_parent" },
                    React__namespace.createElement("div", { className: "broadcast_left" },
                        React__namespace.createElement("div", { className: "broadcast_left_image" },
                            React__namespace.createElement("img", { src: page4.brodcast_image, alt: "swaminarayan" })),
                        React__namespace.createElement("div", { className: "content broadcast_padding" },
                            React__namespace.createElement("h3", null, page4.title),
                            React__namespace.createElement("p", { className: "title" }, page4.sub_title),
                            React__namespace.createElement("p", { className: "sub-text", dangerouslySetInnerHTML: { __html: page4.description } }))),
                    React__namespace.createElement("div", { className: "pipeline pipeline1" }),
                    React__namespace.createElement("div", { className: "pipeline pipeline2" }),
                    React__namespace.createElement("div", { className: "pipeline pipeline3" })),
                React__namespace.createElement(Col$1, { lg: 6, className: "broadcast_right_parent broadcast_padding" },
                    React__namespace.createElement("div", { className: "broadcast_right" },
                        React__namespace.createElement("h3", { dangerouslySetInnerHTML: { __html: page4.quote_text } }),
                        React__namespace.createElement("p", { dangerouslySetInnerHTML: { __html: page4.quote_subtext } })))))));
};
...
var AboutDiv = function (_a) {
    ...
    return (React__namespace.createElement(Row$1, null, aboutdiv.map(function (value, index) {
        return React__namespace.createElement(Col$1, { md: 6, lg: 3, className: "aboutdiv-col", key: index },
            React__namespace.createElement("div", { className: "aboutdiv" },
                React__namespace.createElement("div", { className: "aboutdiv-image" },
                    React__namespace.createElement("img", { src: value.image, alt: "Image not found" })),
                React__namespace.createElement("h4", { className: "aboutdiv-heading mt-4" }, value.title),
                React__namespace.createElement("p", { className: "aboutdiv-para" }, value.text)));
    })));
};
...
var About = function (_a) {
    var page5 = _a.page5;
    return (React__namespace.createElement("section", { className: "about" },
        React__namespace.createElement("img", { className: "about-img", src: page5.about_image, alt: "Image not found" }),
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, { lg: 6 },
                    React__namespace.createElement("h5", { className: "about-heading" }, page5.about_heading),
                    React__namespace.createElement("h2", { className: "about-subheading", dangerouslySetInnerHTML: { __html: page5.about_subheading } })),
                React__namespace.createElement(Col$1, { lg: 6 },
                    React__namespace.createElement("p", { className: "about-para" }, page5.about_para1),
                    React__namespace.createElement("p", { className: "about-para" }, page5.about_para2))),
            React__namespace.createElement(AboutDiv, { aboutdiv: page5.about_values }))));
};
...
var Heading = function (props) {
    return (React__namespace.createElement(Row$1, null,
        React__namespace.createElement(Col$1, { lg: 12, className: "heading-col" },
            React__namespace.createElement("h2", { className: "heading" }, props.heading),
            React__namespace.createElement("img", { src: "/Images/Seperator.png", alt: "underline" }))));
};
...
var Review = function (_a) {
    var page6 = _a.page6;
    return (React__namespace.createElement("section", { className: "review" },
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, null,
                    React__namespace.createElement(Heading, { heading: "What they Say" }))),
            React__namespace.createElement(Row$1, null, page6.review.map(function (value, index) {
                return React__namespace.createElement(Col$1, { md: 6, lg: 4, className: "review-col", key: index },
                    React__namespace.createElement("div", { className: "review-images" },
                        React__namespace.createElement("img", { src: value.image, alt: "Image not found" }),
                        React__namespace.createElement("div", { className: "review-para" },
                            React__namespace.createElement("h5", null, value.title),
                            React__namespace.createElement("h5", null, value.text))));
            })))));
};
...
var Cal = function (_a) {
    var data = _a.data;
    return (React__namespace.createElement(Col$1, { md: 6, lg: 4 },
        React__namespace.createElement("div", { className: "cal_container" },
            React__namespace.createElement("div", { className: "cal_left" },
                React__namespace.createElement("p", { className: "small_title" }, data.day),
                React__namespace.createElement("p", { className: "date" }, data.month),
                React__namespace.createElement("div", { className: "line" }),
                React__namespace.createElement("p", { className: "date" }, data.date)),
            React__namespace.createElement("div", { className: "cal_right" },
                React__namespace.createElement("div", { className: "first" },
                    React__namespace.createElement("p", null, data.event_title),
                    React__namespace.createElement("img", { src: "/Images/Group 30.png", alt: "radio" })),
                React__namespace.createElement("p", { className: "title" }, data.event_describe)))));
};
...
var Calendar = function (_a) {
    ...
    var getCalendar = function () {
        ...
        result = page7.calendar.map(function (e, i) {
            return React__namespace.createElement(Cal, { data: e, key: i });
        });
        return result;
    };
    return (React__namespace.createElement("section", { className: "calendar" },
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, null,
                    React__namespace.createElement(Heading, { heading: "Calendar" }))),
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, { className: "calendar-heading" },
                    React__namespace.createElement("h3", { className: "heading active" }, page7.heading1),
                    React__namespace.createElement("h3", { className: "heading" }, page7.heading2))),
            React__namespace.createElement(Row$1, { className: "mt-5" }, getCalendar()))));
};
...
var Newscard = function (_a) {
    var page8 = _a.page8;
    return (React__namespace.createElement(Row$1, { className: "newscard" },
        page8.images.map(function (value, index) {
            return React__namespace.createElement("div", { className: "newscard-div", key: index },
                React__namespace.createElement("img", { src: value.image, alt: "Image not Found" }),
                React__namespace.createElement("div", null,
                    React__namespace.createElement("p", { className: "para-card" },
                        "Posted By ",
                        React__namespace.createElement("span", null, value.title)),
                    React__namespace.createElement("h5", { className: "card-heading" }, value.text)));
        }),
        React__namespace.createElement("div", { className: "news-button" },
            React__namespace.createElement("button", null, "view more"))));
};
...
var News = function (_a) {
    ...
    return (React__namespace.createElement("section", { className: "news" },
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Heading, { heading: "News" }),
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, { lg: 12 },
                    React__namespace.createElement(reactMultiCarousel, { ssr: true, partialVisbile: true, deviceType: deviceType, itemClass: "image-item", responsive: responsive }, page8.images.map(function (value, index) {
                        return React__namespace.createElement("div", { className: "news-card", key: index },
                            React__namespace.createElement("img", { src: value.image, alt: "Image not Found" }),
                            React__namespace.createElement("div", null,
                                React__namespace.createElement("p", { className: "para-card" },
                                    "Posted By ",
                    ...
                    React__namespace.createElement("div", { className: "news-button" },
                        React__namespace.createElement("button", null, "view more")),
                    React__namespace.createElement(Newscard, { page8: page8 }))))));
};
...
var Maps = function (_a) {
    var page9 = _a.page9;
    return (React__namespace.createElement("section", { className: "maps" },
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Row$1, null,
                React__namespace.createElement(Col$1, { lg: 2 },
                    React__namespace.createElement("h6", { className: "maps-para" }, page9.title),
                    React__namespace.createElement("h3", { className: "maps-heading" }, page9.heading)),
                React__namespace.createElement(Col$1, { lg: 10, className: "ml-2" },
                    React__namespace.createElement(Row$1, null,
                        page9.maps_name.map(function (value, index) {
                            return React__namespace.createElement(Col$1, { xs: 6, sm: 6, md: 6, lg: 2, key: index, className: "maps-name-col" },
                                React__namespace.createElement("div", { className: "maps-name" },
                                    React__namespace.createElement("h3", null, value)));
                        }),
                        React__namespace.createElement(Col$1, { lg: 2 })))))));
};
...
var Websites = function (_a) {
    ...
    return (React__namespace.createElement("section", { className: "websites" },
        React__namespace.createElement(Container$1, null,
            React__namespace.createElement(Heading, { heading: "Our Websites" }),
            React__namespace.createElement(Row$1, { className: "website-row" }, page10.website.map(function (value, index) {
                return React__namespace.createElement(Col$1, { md: 6, lg: 3, key: index, className: "d-flex justify-content-center" },
                    React__namespace.createElement("div", { className: "website-image" },
                        React__namespace.createElement("div", { className: "website-image-parent" },
                            React__namespace.createElement("img", { src: value.image, alt: "Image" })),
                        React__namespace.createElement("p", { className: "mt-2" }, value.text)));
            })))));
};
...
var TestComponent = function (_a) {
    ...
    return (React__namespace.createElement("div", null,
        React__namespace.createElement(Brodcast, { page3: main.page3, page4: main.page4 }),
        React__namespace.createElement(About, { page5: main.page5 }),
        React__namespace.createElement(Review, { page6: main.page6 }),
        React__namespace.createElement(Calendar, { page7: main.page7 }),
        React__namespace.createElement(News, { deviceType: deviceType, page8: main.page8 }),
        React__namespace.createElement(Maps, { page9: main.page9 }),
        React__namespace.createElement(Websites, { page10: main.page10 })));
};

exports.Main = TestComponent;
exports.TestComponent = TestComponent$1;
